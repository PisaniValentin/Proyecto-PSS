...
type TipoDeporteUI = "FÚTBOL" | "BÁSQUET" | "NATACIÓN" | "HANDBALL";
...
function apiToUi(c: CanchaAPI): FormUI {
  return {
    nombre: c.nombre ?? "",
    tipoDeporte: (deporteApiToUi[c.tipoDeporte] ?? "FÚTBOL") as TipoDeporteUI,
          ...
          <div className="space-y-3">
            {canchas.map((c) => (
              <div
                ...
                className={`border rounded-lg px-3 py-2 flex items-center justify-between gap-2 hover:bg-gray-50 transition-colors cursor-pointer ${
                  selectedId === c.id ? "border-blue-300 bg-blue-50" : "border-gray-200"
                }`}
              >
