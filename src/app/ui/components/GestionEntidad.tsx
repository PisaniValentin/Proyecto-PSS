...
export default function GestionEntidad({ tipo }: GestionEntidadProps) {
    const [modal, setModal] = useState<"crear" | "modificar" | "eliminar" | null>(null);
    ...
    return (
        <Box className="p-8">
            ...
            <Grid container spacing={2}>
                ...
                <Grid>
                    <Button variant="outlined" color="secondary" onClick={() => handleOpen("modificar")}>
                        Modificar {tipo}
                    </Button>
                </Grid>
                <Grid>
                    <Button variant="outlined" color="error" onClick={() => handleOpen("eliminar")}>
                        Eliminar {tipo}
                    </Button>
                </Grid>
            </Grid>
